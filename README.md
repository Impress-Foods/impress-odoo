...
--- | --- | --- | ---
[delivery_auto_select_carrier](delivery_auto_select_carrier/) | 19.0.1.0.0 |  | Delivery_auto_select_carrier Summary
[delivery_clickship](delivery_clickship/) | 19.0.1.0.0 |  | Clickship delivery provider
[delivery_common](delivery_common/) | 19.0.1.0.1 |  | Base module for Impress Delivery Connectors
[delivery_obibox](delivery_obibox/) | 19.0.1.0.0 |  | Obibox Delivery Connector
[delivery_pickup](delivery_pickup/) | 19.0.1.0.0 |  | Pickup Delivery Connector
...
[impress_maintenance](impress_maintenance/) | 19.0.0.0.1 |  | Impress_maintenance Summary
[impress_maintenance_quality_mgmt](impress_maintenance_quality_mgmt/) | 19.0.1.0.0 |  | Impress Foods quality management for maintenance
...
[maintenance_consume_stock](maintenance_consume_stock/) | 19.0.0.0.2 |  | Module to allow stock usage in maintenance requests
[maintenance_documents](maintenance_documents/) | 19.0.1.0.0 |  | Bridge module between Maintenance and Documents
[maintenance_product_list](maintenance_product_list/) | 19.0.1.0.0 |  | Allows to link products to maintenance equipments
[maintenance_quality](maintenance_quality/) | 19.0.0.0.1 |  | Bridge module between Maintenance and Quality Control
[maintenance_sequence](maintenance_sequence/) | 19.0.1.0.0 |  | Maintenance_sequence Summary
